...
public class DefaultConfigurationDependencyHandler implements ConfigurationDependencyHandler {
    private final DependencyFactory dependencyFactory;
    private final Configuration configuration;

    @Inject
    public DefaultConfigurationDependencyHandler(DependencyFactory dependencyFactory, Configuration configuration) {
    ...
    public String toString() {
        return ConfigurationDependencyHandler.class.getSimpleName() + " for " + configuration.getName();
    }
}
